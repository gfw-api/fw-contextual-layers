...
[![Build Status](https://travis-ci.com/gfw-api/fw-contextual-layers.svg?branch=dev)](https://travis-ci.org/gfw-api/fw-contextual-layers)
...
The FW Context Layer microservice is built using [Node.js](https://nodejs.org/en/), and can be executed either natively or using Docker, each of which has its own set of requirements.
...
```
./fw-contextual-layers.sh develop
```
